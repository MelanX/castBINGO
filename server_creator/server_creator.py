...
def main():
    ...
    for mod in mods:
        ...
        mod_name = re.sub("https://edge\.forgecdn\.net/files/[0-9]*/[0-9]*/", "", file_url)  # haaaaax

        with open(sys.argv[1] + os.path.sep + 'mods' + os.path.sep + file_url[file_url.rfind('/') + 1:]) as target:
